...
async function bootstrap() {
    ...
    app.useGlobalInterceptors(new logging_interceptor_1.LoggingInterceptor(), new performance_interceptor_1.PerformanceInterceptor(), new response_interceptor_1.ResponseInterceptor(), new debug_interceptor_1.DebugInterceptor());
